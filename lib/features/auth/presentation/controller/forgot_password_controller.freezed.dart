...
class _$ForgotPasswordStateImpl implements _ForgotPasswordState {
  _$ForgotPasswordStateImpl({this.token, this.email});
  ...
  @override
  String toString() {
    return 'ForgotPasswordState(token: $token, email: $email)';
  }
...
abstract class _ForgotPasswordState implements ForgotPasswordState {
  factory _ForgotPasswordState({final String? token, final String? email}) =
