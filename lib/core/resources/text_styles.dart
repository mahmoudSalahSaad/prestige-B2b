...
extension TextCustom on TextStyle {
  ...
  TextStyle activeLiteColor() => (this).copyWith(color: primaryOrangeColor);
  ...
  TextStyle titleStyle({double fontSize = 16}) => (this).copyWith(fontSize: fontSize.sp, color: textPrimary, fontWeight: FontWeight.w700, fontFamily: "jf-flat");
  TextStyle regularStyle({double fontSize = 14}) => (this).copyWith(fontSize: fontSize.sp, color: Colors.white, fontWeight: FontWeight.w400, fontFamily: "jf-flat");
  TextStyle descriptionStyle({double fontSize = 12}) => (this).copyWith(fontSize: fontSize.sp, color: textSecondary, fontWeight: FontWeight.w300, fontFamily: "jf-flat");
}
