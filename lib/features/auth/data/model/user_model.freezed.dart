...
class _$CityModelImpl implements _CityModel {
  _$CityModelImpl({this.id, this.name, this.slug});
  ...
  @override
  String toString() {
    return 'CityModel(id: $id, name: $name, slug: $slug)';
  }
...
abstract class _CityModel implements CityModel {
  factory _CityModel({final int? id, final String? name, final String? slug}) =
      _$CityModelImpl;
