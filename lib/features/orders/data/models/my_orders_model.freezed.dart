...
mixin _$MyOrdersModel {
  List<OrderModel>? get items => throw _privateConstructorUsedError;

  /// Serializes this MyOrdersModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of MyOrdersModel
...
abstract class $MyOrdersModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<OrderModel>? items});
}
...
class _$MyOrdersModelImpl implements _MyOrdersModel {
  _$MyOrdersModelImpl({final List<OrderModel>? items}) : _items = items;
  ...
  @override
  String toString() {
    return 'MyOrdersModel(items: $items)';
  }
...
abstract class _MyOrdersModel implements MyOrdersModel {
  factory _MyOrdersModel({final List<OrderModel>? items}) = _$MyOrdersModelImpl;
