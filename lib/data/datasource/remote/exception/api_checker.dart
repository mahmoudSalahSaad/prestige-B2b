...
import 'package:shop/core/utils/logger.dart';

import 'package:shop/data/base/api_response.dart';
import 'package:shop/data/base/error_response.dart';
import 'package:shop/data/base/response_model.dart';
import 'package:shop/locale_keys.g.dart';
  ...
  static ResponseModel<T> checkApi<T>({bool showError = true, ApiResponse? apiResponse, dynamic message}) {
    ...
    try {
      ...
      if (errorResponse.message != null && errorResponse.message!.isNotEmpty) {
        ...
        _showAlert((LocaleKeys.error), showError);
        return ResponseModel<T>(false, (LocaleKeys.error));
      }
    } catch (e) {
